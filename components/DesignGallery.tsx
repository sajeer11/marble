    ...
    return (
        <section className="bg-white py-16 md:py-24 px-4 overflow-hidden">
            <div className="text-center mb-12">
                <p className="text-darkGray font-medium text-lg">{subtitle}</p>
                <h2 className="text-4xl md:text-5xl font-bold font-display text-secondary">{title}</h2>
            </div>
