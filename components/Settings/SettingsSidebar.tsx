    ...
    <div className="md:col-span-1">
      <div className="bg-white dark:bg-surface-dark rounded-lg shadow-lg overflow-hidden sticky top-24">
        ...
        <div className="border-t dark:border-gray-700 p-4">
          <button className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all text-left font-semibold">
