...
export const metadata = {
  title: 'Register | MarbleLux',
  description: 'Create a new MarbleLux account',
};
    ...
    <div className="flex flex-1 min-h-screen">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-background-light dark:bg-background-dark">
        <div className="w-full max-w-md space-y-10">
          <div>
            <h1 className="text-4xl font-bold font-display text-gray-900 dark:text-white mb-2">Join Us</h1>
            <p className="text-gray-500 dark:text-gray-400">Create your account and discover premium stones.</p>
          </div>
          ...
          <form className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input type="text" placeholder="Your name" className="w-full h-14 pl-12 rounded-lg border-gray-200 dark:border-gray-700 bg-white dark:bg-surface-dark focus:ring-primary focus:border-primary transition-all" />
              </div>
            </div>
            <div className="space-y-2">
      ...
      <div className="hidden lg:block w-1/2 relative">
        ...
        <div className="absolute bottom-20 left-20 right-20 text-white space-y-6">
          <blockquote className="text-4xl font-display font-medium leading-tight">
            "Join the community of design enthusiasts who choose quality."
          </blockquote>
          <p className="text-sm font-bold uppercase tracking-widest opacity-80">Premium Marble & Stone</p>
        </div>
      </div>
    </div>
  );
