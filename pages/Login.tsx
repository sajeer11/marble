  ...
  return (
    <div className="flex flex-1 min-h-screen">
      ...
      <div className="hidden lg:block w-1/2 relative">
        <img src="https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?auto=format&fit=crop&w=1200&q=80" className="absolute inset-0 w-full h-full object-cover" />
